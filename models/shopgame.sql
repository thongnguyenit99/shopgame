...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2020 at 01:00 PM
...
(11, NULL, 'pes 6', 'pes 6 cùi', 5865, 0, 'demo.png', 'bình dương', 0),
(20, NULL, 'pes 6', 'ggtgtg', 555, 0, 'cart.png', 'viet nam', 0),
(23, 8, 'Apex Legends - 1000 Apex Coins', '<p>Sản phẩm game hay nhất tháng 9 năm 2020</p>', 360000, 350000, 'apex-legends.jpg', 'Thái Lan', 0),
(24, 9, 'Metro 2033 Redux', '<p>Năm 2013, thế giới bị tàn phá bởi một sự kiện khải huyền, tiêu diệt gần như toàn bộ nhân loại và biến bề mặt Trái đất thành một vùng đất hoang độc. Một số ít những người sống sót đã ẩn náu ở sâu dưới lòng đất Moscow, và nền văn minh nhân loại bước vào một Kỷ nguyên đen tối mới. Năm 2033.</p>', 187000, 0, 'metro-2033.jpg', 'Campuchia', 0),
(25, 10, 'Crusader Kings III', '<p>Paradox Development Studio mang đến cho bạn phần tiếp theo của một trong những trò chơi chiến lược phổ biến nhất từng được sản xuất. Crusader Kings III là người thừa kế một di sản lâu đời của kinh nghiệm chiến lược vĩ đại lịch sử và đến với một loạt các cách thức mới để đảm bảo sự thành công của ngôi nhà hoàng gia của bạn.</p>', 389000, 0, 'crusader-kings-iii.jpg', 'Hàn Quốc', 0),
(26, 11, 'Battlefield 4', '<p>Battlefield 4 là game bắn súng góc nhìn thứ nhất được phát triển bởi DICE - EA Digital Illusions CE và được xuất bản bởi Electronic Arts. Trò chơi là phần tiếp theo của Battlefield 3 và phần thứ 13 trong loạt Battlefield</p>', 400000, 300000, 'battlefield-4.jpg', 'Nhật', 0);
...
(1, 'quantrivien', '$2b$12$um0T/DljzZj8V7ExFBgS1u1rpeyWKN6DLsiBO68m8Ut12jDZ8Z9ze');
